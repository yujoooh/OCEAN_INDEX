...
#산출된 예보지수자료 읽기-------------------------------------------------------------------------
SPEQ_INF = open(dir1+'/SPEQ_INDEX_SERVICE_onair_'+today+'.csv',encoding='utf8')
...
nn = int((SPEQ_LEN-1)*1/7)
while kk < int((SPEQ_LEN-1)*3/7):
...
OUT_FNAME=dir1+'/SPEQ_INDEX_SERVICE_onair_'+today+'.csv'
