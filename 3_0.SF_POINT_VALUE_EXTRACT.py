...
print("#SFEQ OBS data extract Start==========")
...
#print(KMA_OBS[0], KMA_OBS[1], KMA_OBS[2],KMA_OBS[3],KMA_OBS)
...
for LIST in INDEX_LIST:
	...
	#while ii <= 1 :
		...
		RWW3_X = int(DEV[14]) ; RWW3_Y = int(DEV[15]) ; MOHID_X = int(DEV[16]) ; MOHID_X = int(DEV[17]) ; W_AREA = DEV[20]
