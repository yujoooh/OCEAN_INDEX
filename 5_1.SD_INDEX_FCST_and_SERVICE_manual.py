	...
	if YMD == today :
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				if SD_TIME[3] == 'daily' or SD_TIME[3] == 'AM' or SD_TIME[3] =='PM':
					...
					DAY1.append([STN, AREA, W_AREA, NAME, today, SD_TIME[0], SD_TIME[1], SD_TIME[2], SD_TIME[3], int(round(TEMP_S[0])),  int(round(TEMP_S[2])), int(round(TEMP_S[1])), int(round(WIND_S[0])),int(round(WIND_S[2])), int(round(WIND_S[1]))])	
			ii = ii + 1
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				if SD_TIME[3] == 'daily' or SD_TIME[3] == 'AM' or SD_TIME[3] =='PM':
					...
					DAY2.append([STN, AREA, W_AREA, NAME, afterday1, SD_TIME[0], SD_TIME[1], SD_TIME[2], SD_TIME[3], int(round(TEMP_S[0])),  int(round(TEMP_S[2])), int(round(TEMP_S[1])), int(round(WIND_S[0])),int(round(WIND_S[2])), int(round(WIND_S[1]))])	
			ii = ii + 1
	elif YMD == afterday2 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		SD_TIME = SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				if SD_TIME[3] == 'daily' or SD_TIME[3] == 'AM' or SD_TIME[3] =='PM':
					...
					DAY4.append([STN, AREA, W_AREA, NAME, afterday3, SD_TIME[0], SD_TIME[1], SD_TIME[2], SD_TIME[3], int(round(TEMP_S[0])),  int(round(TEMP_S[2])), int(round(TEMP_S[1])), int(round(WIND_S[0])),int(round(WIND_S[2])), int(round(WIND_S[1]))])	
			ii = ii + 1	
	elif YMD == afterday4 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		SD_TIME = SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				if SD_TIME[3] == 'daily' or SD_TIME[3] == 'AM' or SD_TIME[3] =='PM':
					...
					DAY5.append([STN, AREA, W_AREA, NAME, afterday4, SD_TIME[0], SD_TIME[1], SD_TIME[2], SD_TIME[3], int(round(TEMP_S[0])),  int(round(TEMP_S[2])), int(round(TEMP_S[1])), int(round(WIND_S[0])),int(round(WIND_S[2])), int(round(WIND_S[1]))])	
			ii = ii + 1
	elif YMD == afterday5 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		SD_TIME = SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				if SD_TIME[3] == 'daily' or SD_TIME[3] == 'AM' or SD_TIME[3] =='PM':
					...
					DAY6.append([STN, AREA, W_AREA, NAME, afterday5, SD_TIME[0], SD_TIME[1], SD_TIME[2], SD_TIME[3], int(round(TEMP_S[0])),  int(round(TEMP_S[2])), int(round(TEMP_S[1])), int(round(WIND_S[0])),int(round(WIND_S[2])), int(round(WIND_S[1]))])	
			ii = ii + 1
	elif YMD == afterday6 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		SD_TIME = SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				...
				DAY7.append([STN, AREA, W_AREA, NAME, afterday6, SD_TIME[0], SD_TIME[1], SD_TIME[2], SD_TIME[3], int(round(TEMP_S[0])),  int(round(TEMP_S[2])), int(round(TEMP_S[1])), int(round(WIND_S[0])),int(round(WIND_S[2])), int(round(WIND_S[1]))])
			ii = ii + 1
