...
python 0_1.KMA_CITY_FORECAST_API_ST.py >> %logfile%
...
rem python 0_6.KHOA_OBS_DAILY_DBTXT.py >> %logfile% rem OPeNDAP에서 자료 받는 부분까지 해당 프로그램에 포함되어있음  rem [python 0_6.KHOA_OBS_API_DAILY.py >> %logfile% rem API는 임시로..]
