...
COM_INDEX2.to_csv('./Result/'+today+'/'+today +
                  '_SREQ_INDEX_FCST_MID.csv', encoding='utf8', index=False)
#COM_INDEX2.to_csv('./Result/'+today+'/'+today+'_SURFING_INDEX_FCST_mid_euckr.csv', encoding = 'euc-kr', index=False)
COM_INDEX.to_csv('./Result/'+today+'/'+today +
                 '_SREQ_INDEX_SERVICE_MID.csv', encoding='utf8', index=False)
