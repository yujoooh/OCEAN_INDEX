...
from Function.element_function_onair import Element_extract
...
for FCST_AREA in FORECAST_AREA : 
	...
	#[Output Data] ========================================================================================
	OUT_FNAME1 = dir1+'/ST_TIMESERIES_'+FCST_AREA+'_onair_'+today+'.csv'   # 시계열
	OUT_FNAME2 = dir1+'/ST_INDEX_FCST_'+FCST_AREA+'_onair_'+today+'.csv'   # 예보지수

	COM_TIME_DF.to_csv(OUT_FNAME1,mode='w',encoding='euc-kr', index=False)
	SEA_TRAVEL_INDEX.to_csv(OUT_FNAME2,mode='w',encoding='euc-kr', index=False)
