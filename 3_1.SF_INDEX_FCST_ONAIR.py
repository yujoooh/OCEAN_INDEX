...
#[Info Data Read]=========================================================================================
POINT_INF = open('./Info/SF_Point_Info_ONAIR.csv','r',encoding='utf8')
...
while ii <= INF_LEN-1 :
	...
	if today[4:6] == '01' or today[4:6] =='02' or today[4:6] =='03' or today[4:6] =='11' or today[4:6] =='12' : 
		...
		jj = 0 ; jjj = 0
		while jj <= 144:
			WIND_2S = Statistic().min_max_ave('KHOA', 'daily', WIND, WRF_X, WRF_Y, jj)
			WIND_S = Statistic().min_max_ave('KHOA', 'daily', WIND, WRF_X, WRF_Y, jj)
			TEMP_2S = Statistic().min_max_ave('KHOA', 'daily', TEMP, WRF_X, WRF_Y, jj)
			...
			if jj == 0  :
				DAY1.append([STN, AREA, W_AREA, NAME, today, 'DY', FISH_NAME, FISH_TYPE, TODAY_MUL, WAVE_2S[0], WAVE_2S[2], WAVE_2S[1], SST_2S[0], SST_2S[2], SST_2S[1], TEMP_2S[0], TEMP_2S[2], TEMP_2S[1], WIND_2S[0], WIND_2S[2], WIND_2S[1]])
			if jj == 24 :
				DAY2.append([STN, AREA, W_AREA, NAME, afterday1, 'DY', FISH_NAME, FISH_TYPE, AFTERDAY1_MUL, WAVE_2S[0], WAVE_2S[2], WAVE_2S[1], SST_2S[0], SST_2S[2], SST_2S[1], TEMP_2S[0], TEMP_2S[2], TEMP_2S[1], WIND_2S[0], WIND_2S[2], WIND_2S[1]])
			if jj == 48 :
				DAY3.append([STN, AREA, W_AREA, NAME, afterday2, 'DY', FISH_NAME, FISH_TYPE, AFTERDAY2_MUL, WAVE_2S[0], WAVE_2S[2], WAVE_2S[1], SST_2S[0], SST_2S[2], SST_2S[1], TEMP_2S[0], TEMP_2S[2], TEMP_2S[1], WIND_2S[0], WIND_2S[2], WIND_2S[1]])
			if jj == 72 :
...
#[Output Data] ========================================================================================
OUT_FNAME1=dir1+'/SFEQ_INDEX_FCST_onair_'+today+'.csv'
...
OUT_FNAME2=dir1+'/SFEQ_INDEX_SERVICE_onair_'+today+'.csv'
