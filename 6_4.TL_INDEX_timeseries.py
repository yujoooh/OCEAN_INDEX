...
print("#TLEQ Timeseries CREAT Start==========")
...
if not os.path.exists(dir1+'/TL_CITY_time.csv'): # 동네예보 수집 에러에 따른 자료 미생성시 그냥 예측자료 사용
	print('CITY_FORECAST DATA Not found') ; CITY_LEN=0
else:
	CITY_INF = open(dir1+'/TL_CITY_time.csv','r',encoding='utf8')
...
#[Output Data] ========================================================================================
OUT_FNAME1 = dir1+'/TL_TIMESERIES_'+today+'.csv'   # 시계열
COM_TIME_DF.to_csv(OUT_FNAME1,mode='w',encoding='utf8', index=False)

print("#TLEQ Timeseries CREAT Complete==========")
