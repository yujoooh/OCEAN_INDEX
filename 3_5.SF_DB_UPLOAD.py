...
while ii <= len(content1)-1 :
	...
	YR = DEV[4][0:4]; MN = DEV[4][4:6] ; DY = DEV[4][6:8]
	...
	print(CODE, YMD, TIDE, TIDE_SCORE, MIN_WHT, AVE_WHT, MAX_WHT, WAVE_SCORE, MIN_SST, AVE_SST, MAX_SST, SST_SCORE, MIN_TEMP, AVE_TEMP, MAX_TEMP, TEMP_SCORE, MIN_WSPD, AVE_WSPD, MAX_WSPD, WSPD_SCORE, WARN, WARN_SCORE, TOTAL)
	...
	sqlStr += f"on (SF_CODE='{CODE}' and PRED_DATE='{YR}-{MN}-{DY}')  "
	...
	sqlStr += f"insert (SF_CODE, PRED_DATE, SF_FISH_NAME, SF_FISH_TYPE, TIDE_TIME, TE_SCORE, MIN_WAVE_HEIGHT, AVG_WAVE_HEIGHT, MAX_WAVE_HEIGHT, WH_SCORE, MIN_WATER_TEMP, AVG_WATER_TEMP, MAX_WATER_TEMP, WT_SCORE, MIN_AIR_TEMP, AVG_AIR_TEMP, MAX_AIR_TEMP, AT_SCORE, MIN_WIND_SPEED, AVG_WIND_SPEED, MAX_WIND_SPEED, WS_SCORE, TOTAL_SCORE, WARN, WARN_SCORE)  "
	sqlStr += f"values ('{CODE}', '{YR}-{MN}-{DY}', '{NAME}', '{TYPE}',{TIDE}, {TIDE_SCORE}, {MIN_WHT}, {AVE_WHT}, {MAX_WHT}, {WAVE_SCORE}, {MIN_SST}, {AVE_SST}, {MAX_SST}, {SST_SCORE}, {MIN_TEMP}, {AVE_TEMP}, {MAX_TEMP}, {TEMP_SCORE}, {MIN_WSPD}, {AVE_WSPD}, {MAX_WSPD}, {WSPD_SCORE}, {TOTAL}, '{WARN}', {WARN_SCORE})  "
