...
#산출된 예보지수자료 읽기-------------------------------------------------------------------------
SSEQ_INF = open(dir1+'/SSEQ_INDEX_SERVICE_onair_'+today+'.csv',encoding='utf8')
...
OUT_FNAME=dir1+'/SSEQ_INDEX_SERVICE_onair_'+today+'.csv'
