...
#[Info Data Read]=========================================================================================
POINT_INF = open('./Info/SD_Point_Info_ONAIR.csv','r',encoding='utf8')
...
#[Output Data] ========================================================================================
OUT_FNAME1=dir1+'/SDEQ_INDEX_FCST_onair_'+today+'.csv'
with open(OUT_FNAME1,'w',encoding='utf8') as file:
	...
	while ii <= COM_LEN-1 :
		...
		if COM[ii][8] != 0 :
			...
			ii = ii + 1
			continue
OUT_FNAME2=dir1+'/SDEQ_INDEX_SERVICE_onair_'+today+'.csv'
