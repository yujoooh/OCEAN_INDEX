...
while ii <= INF_LEN-1 :
	...
	while jj <= 144:
		...
		if jj == 0 : # today am/pm data 
			DAY1.append([STN, AREA, W_AREA, NAME, today, 'DY', TEMP_2S[2], SST_2S[2], WIND_2S[1], WAVE_2S[1]])
		elif jj == 24 :
			DAY2.append([STN, AREA, W_AREA, NAME, afterday1, 'DY', TEMP_2S[2], SST_2S[2], WIND_2S[1], WAVE_2S[1]])
		elif jj == 48 :
			DAY3.append([STN, AREA, W_AREA, NAME, afterday2, 'DY', TEMP_2S[2], SST_2S[2], WIND_2S[1], WAVE_2S[1]])
		elif jj == 72 :
...
while ii <= CITY_LEN-2:
	...
	if CITY_LEN == 0 :
		...
		while jj <= CITY_LEN-1:
			...
			if COM[ii][0] == STN and COM[ii][4] == DATE and COM[ii][5] == 'DY':
...
#[Output Data] ========================================================================================
OUT_FNAME1=dir1+'/SPEQ_INDEX_FCST_onair_'+today+'.csv'
...
OUT_FNAME2=dir1+'/SPEQ_INDEX_SERVICE_onair_'+today+'.csv'
