	...
	for LIST in INDEX_LIST:
		...
		while ii <= len(data1)-24 :
			...
			if data1[ii+9][2] == afterday3 or  data1[ii+9][2] == afterday4 or  data1[ii+9][2] == afterday5 or  data1[ii+9][2] == afterday6 :  
				...
				AIRT_AM_MIN = min(data1[ii+9][4],data1[ii+10][4],data1[ii+11][4],data1[ii+12][4],data1[ii+13][4],data1[ii+14][4],data1[ii+15][4],data1[ii+16][4],data1[ii+17][4],data1[ii+18][4])
				AIRT_AM_MAX = max(data1[ii+9][4],data1[ii+10][4],data1[ii+11][4],data1[ii+12][4],data1[ii+13][4],data1[ii+14][4],data1[ii+15][4],data1[ii+16][4],data1[ii+17][4],data1[ii+18][4])
				AIRT_AM_AVE = (data1[ii+9][4]+data1[ii+10][4]+data1[ii+11][4]+data1[ii+12][4]+data1[ii+13][4]+data1[ii+14][4]+data1[ii+15][4]+data1[ii+16][4]+data1[ii+17][4]+data1[ii+18][4])/10
				
				WSD_AM_MIN = min(data3[ii+9][4],data3[ii+10][4],data3[ii+11][4],data3[ii+12][4],data3[ii+13][4],data3[ii+14][4],data3[ii+15][4],data3[ii+16][4],data3[ii+17][4],data3[ii+18][4])
				WSD_AM_MAX = max(data3[ii+9][4],data3[ii+10][4],data3[ii+11][4],data3[ii+12][4],data3[ii+13][4],data3[ii+14][4],data3[ii+15][4],data3[ii+16][4],data3[ii+17][4],data3[ii+18][4])
				WSD_AM_AVE = (data3[ii+9][4]+data3[ii+10][4]+data3[ii+11][4]+data3[ii+12][4]+data3[ii+13][4]+data3[ii+14][4]+data3[ii+15][4]+data3[ii+16][4]+data3[ii+17][4]+data3[ii+18][4])/10
		
				#하늘상태 보수적으로 적용 [맑음:1, 구름조금:2, 구름많음:3, 흐림:4]
				SKY_AM = max(data2[ii+9][4],data2[ii+10][4],data2[ii+11][4],data2[ii+12][4],data2[ii+13][4],data2[ii+14][4],data2[ii+15][4],data2[ii+16][4],data2[ii+17][4],data2[ii+18][4])
		
				#강수량 오전 오후 합계
				RAIN_AMT_AM = data5[ii+12][5]+data5[ii+18][5]
