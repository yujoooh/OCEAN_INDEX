...
nn = int((SFEQ_LEN-1)*2/10)
while kk < int((SFEQ_LEN-1)*6/10):
	mm = 0
	ll = 0
	while mm < AM_LEN:
		if fdata[kk][0] == odata1[mm][0] :# 예보지역과 관측지역 일치여부
