...
#[Info Data Read]=========================================================================================
POINT_INF = open('./Info/SS_Point_Info_ONAIR.csv','r',encoding='utf8')
	...
	while jj <= 144:
		if os.path.isfile(INFILE_6) :
			if  jj <= 48 and NAME != '울릉도' :
				...
				CURRENT_2S = Statistic().min_max_ave('KHOA', 'ampm', CURRENT, MOHID_X, MOHID_Y, jj)
				...
				CURRENT_2S = Statistic().min_max_ave('KHOA', 'ampm', CURRENT2, ROMS_X, ROMS_Y, jj)
		...
		if os.path.isfile(INFILE_3):
			if jj <= 48 :
				jjj = int(jj / 3) #3시간 자료
				if CWW3_LOC == 1 :
					WAVE_2S = Statistic().min_max_ave('KMA', 'daily', WHT_1, CWW3_X, CWW3_Y, jjj)
					WAVE_S = Statistic().min_max_ave('KMA', 'daily', WHT_1, CWW3_X, CWW3_Y, jjj)
				if CWW3_LOC == 2 :
					WAVE_2S = Statistic().min_max_ave('KMA', 'daily', WHT_2, CWW3_X, CWW3_Y, jjj)
					WAVE_S = Statistic().min_max_ave('KMA', 'daily', WHT_2, CWW3_X, CWW3_Y, jjj)
				if CWW3_LOC == 3 :
					WAVE_2S = Statistic().min_max_ave('KMA', 'daily', WHT_3, CWW3_X, CWW3_Y, jjj)
					WAVE_S = Statistic().min_max_ave('KMA', 'daily', WHT_3, CWW3_X, CWW3_Y, jjj)
				if CWW3_LOC == 4 :
					WAVE_2S = Statistic().min_max_ave('KMA', 'daily', WHT_4, CWW3_X, CWW3_Y, jjj)
					WAVE_S = Statistic().min_max_ave('KMA', 'daily', WHT_4, CWW3_X, CWW3_Y, jjj)
				if CWW3_LOC == 5 :
					WAVE_2S = Statistic().min_max_ave('KMA', 'daily', WHT_5, CWW3_X, CWW3_Y, jjj)
					WAVE_S = Statistic().min_max_ave('KMA', 'daily', WHT_5, CWW3_X, CWW3_Y, jjj)
			else :
				WAVE_2S = Statistic().min_max_ave('KHOA', 'daily', WHT, WW3_X, WW3_Y, jj)
		...
		if jj == 0  :
			DAY1.append([STN, AREA, W_AREA, NAME, today, 'DY' ,TODAY_MUL, round(WAVE_2S[0],1), round(WAVE_2S[2],1), round(WAVE_2S[1],1), round(CURRENT_2S[0],1), round(CURRENT_2S[2],1), round(CURRENT_2S[1],1), round(SST_2S[0],1), round(SST_2S[2],1), round(SST_2S[1],1)])
		if jj == 24 :
			DAY2.append([STN, AREA, W_AREA, NAME, afterday1, 'DY' ,AFTERDAY1_MUL, round(WAVE_2S[0],1), round(WAVE_2S[2],1), round(WAVE_2S[1],1), round(CURRENT_2S[0],1), round(CURRENT_2S[2],1), round(CURRENT_2S[1],1), round(SST_2S[0],1), round(SST_2S[2],1), round(SST_2S[1],1)])
		if jj == 48 :
			DAY3.append([STN, AREA, W_AREA, NAME, afterday2, 'DY' ,AFTERDAY2_MUL, round(WAVE_2S[0],1), round(WAVE_2S[2],1), round(WAVE_2S[1],1), round(CURRENT_2S[0],1), round(CURRENT_2S[2],1), round(CURRENT_2S[1],1), round(SST_2S[0],1), round(SST_2S[2],1), round(SST_2S[1],1)])
		if jj == 72 :
...
#[Output Data] ========================================================================================
OUT_FNAME1=dir1+'/SSEQ_INDEX_FCST_onair_'+today+'.csv'
...
OUT_FNAME2=dir1+'/SSEQ_INDEX_SERVICE_onair_'+today+'.csv'
