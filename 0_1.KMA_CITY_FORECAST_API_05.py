...
if CHECK3 == '10' :
	...
	for LIST in INDEX_LIST:
			...
			while jj <= CITY_LEN2-1 : # 전일 23시 예측자료 기반 당일 00시~05시 자료 수집
				...
				if CATEGORY2 == 'TMP': # 기온정보 수집 : 1시간 간격
					...
					if str(DATE2) == today and (str(TIME2) == '0000' or str(TIME2) == '0100' or str(TIME2) == '0200' or str(TIME2) == '0300' or str(TIME2) == '0400' or str(TIME2) == '0500'):
						data1.append([STN, NAME, DATE2, TIME2[0:2], float(AIRT2)])
				...
				if CATEGORY2 == 'SKY': # 날씨정보 수집 : 1시간 간격 [맑음:1, 구름조금:2, 구름많음:3, 흐림:4]
					...
					if str(DATE2) == today and (str(TIME2) == '0000' or str(TIME2) == '0100' or str(TIME2) == '0200' or str(TIME2) == '0300' or str(TIME2) == '0400' or str(TIME2) == '0500'):
						data2.append([STN, NAME, DATE2, TIME2[0:2], SKY2])
				...
				if CATEGORY2 == 'WSD': # 풍속정보 수집 : 1시간 간격
					...
					if str(DATE2) == today and (str(TIME2) == '0000' or str(TIME2) == '0100' or str(TIME2) == '0200' or str(TIME2) == '0300' or str(TIME2) == '0400' or str(TIME2) == '0500'):
						data3.append([STN, NAME, DATE2, TIME2[0:2], float(WSD2)])
				...
				if CATEGORY2 == 'PCP': # 강수정보 수집 : 1시간 간격
					...
					if str(DATE2) == today and (str(TIME2) == '0000' or str(TIME2) == '0100' or str(TIME2) == '0200' or str(TIME2) == '0300' or str(TIME2) == '0400' or str(TIME2) == '0500'):
						data5.append([STN, NAME, DATE2, TIME2[0:2], RAIN_AMT2, DAY1_RAIN_COM00])
				...
				if CATEGORY2 == 'POP': # 강수확률정보 수집 : 1시간 간격
					...
					if str(DATE2) == today and (str(TIME2) == '0000' or str(TIME2) == '0100' or str(TIME2) == '0200' or str(TIME2) == '0300' or str(TIME2) == '0400' or str(TIME2) == '0500'):
						data6.append([STN, NAME, DATE2, TIME2[0:2], POP2])
				...
				if CATEGORY2 == 'REH': # 습도정보 수집 : 1시간 간격
					...
					# 전일 23시 예측 자료로 금일 00 05시 자료 수집 
					if str(DATE2) == today and (str(TIME2) == '0000' or str(TIME2) == '0100' or str(TIME2) == '0200' or str(TIME2) == '0300' or str(TIME2) == '0400' or str(TIME2) == '0500'):
						data7.append([STN, NAME, DATE2, TIME2[0:2], REH2])
				jj += 1
				...
				while jjj <= CITY_LEN-1:
					...
					if CATEGORY == 'TMP': # 기온정보 수집 : 1시간 간격
						...
						if int(hr) < 14 : # 당일 06시 자료가 있는 0500과 최신자료인 0800 base_time사용
							if bt == '0500' and str(DATE) == today and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800' or str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
								data1.append([STN, NAME, DATE, TIME[0:2], float(AIRT)])
							...
							#	data1.append([STN, NAME, DATE, TIME[0:2], float(AIRT)])
							elif bt == '0500' and (str(DATE) == afterday1 or str(DATE) == afterday2):
								data1.append([STN, NAME, DATE, TIME[0:2], float(AIRT)])
					...
					if CATEGORY == 'SKY': # 날씨정보 수집 : 3시간 간격 [맑음:1, 구름많음:3, 흐림:4]
						...
						if int(hr) < 14 : # 당일 06시 자료가 있는 0500과 최신자료인 0800 base_time사용
							if bt == '0500' and str(DATE) == today and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800' or str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
								data2.append([STN, NAME, DATE, TIME[0:2], SKY])
							#elif bt == '0800' and str(DATE) == today and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
							#	data2.append([STN, NAME, DATE, TIME[0:2], SKY])
							elif bt == '0500' and (str(DATE) == afterday1 or str(DATE) == afterday2):
								data2.append([STN, NAME, DATE, TIME[0:2], SKY])
					...
					if CATEGORY == 'WSD': # 풍속정보 수집 : 1시간 간격
						...
						if int(hr) < 14 : # 당일 06시 자료가 있는 0500과 최신자료인 0800 base_time사용
							if bt == '0500' and str(DATE) == today and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800' or str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
								data3.append([STN, NAME, DATE, TIME[0:2], float(WSD)])
							#elif bt == '0800' and str(DATE) == today and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
							#	data3.append([STN, NAME, DATE, TIME[0:2], float(WSD)])
							elif bt == '0500' and (str(DATE) == afterday1 or str(DATE) == afterday2):
								data3.append([STN, NAME, DATE, TIME[0:2], float(WSD)])
					...
					if CATEGORY == 'PCP': # 강수정보 수집 : 6시간 간격
						...
						if int(hr) < 14 : # 당일 06시 자료가 있는 0500과 최신자료인 0800 base_time사용
							...
							if bt == '0500' and str(DATE) == today and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200'): DAY1_RAIN_COM09 = DAY1_RAIN_COM09 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == today and (str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800'): DAY1_RAIN_COM13 = DAY1_RAIN_COM13 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == today and (str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'): DAY1_RAIN_COM19 = DAY1_RAIN_COM19 + float(RAIN_AMT)

							if bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '0000' or str(TIME) == '0100' or str(TIME) == '0200' or str(TIME) == '0300' or str(TIME) == '0400' or str(TIME) == '0500'): DAY2_RAIN_COM00 = DAY2_RAIN_COM00 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800'): DAY2_RAIN_COM06 = DAY2_RAIN_COM06 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200'): DAY2_RAIN_COM09 = DAY2_RAIN_COM09 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800'): DAY2_RAIN_COM13 = DAY2_RAIN_COM13 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'): DAY2_RAIN_COM19 = DAY2_RAIN_COM19 + float(RAIN_AMT)

							if bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '0000' or str(TIME) == '0100' or str(TIME) == '0200' or str(TIME) == '0300' or str(TIME) == '0400' or str(TIME) == '0500'): DAY3_RAIN_COM00 = DAY3_RAIN_COM00 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800'): DAY3_RAIN_COM06 = DAY3_RAIN_COM06 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200'): DAY3_RAIN_COM09 = DAY3_RAIN_COM09 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800'): DAY3_RAIN_COM13 = DAY3_RAIN_COM13 + float(RAIN_AMT)
							if bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'): DAY3_RAIN_COM19 = DAY3_RAIN_COM19 + float(RAIN_AMT)

							if bt == '0500' and str(DATE) == today and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY1_RAIN_COM06])
							elif bt == '0500' and str(DATE) == today and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200') :
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY1_RAIN_COM09])
							elif bt == '0500' and str(DATE) == today and (str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY1_RAIN_COM13])
							elif bt == '0500' and str(DATE) == today and (str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY1_RAIN_COM19])
							
							elif bt == '0500' and str(DATE) == afterday1 and(str(TIME) == '0000' or str(TIME) == '0100' or str(TIME) == '0200' or str(TIME) == '0300' or str(TIME) == '0400' or str(TIME) == '0500'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY2_RAIN_COM00])
							elif bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY2_RAIN_COM06])
							elif bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200') :
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY2_RAIN_COM09])
							elif bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY2_RAIN_COM13])
							elif bt == '0500' and str(DATE) == afterday1 and (str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY2_RAIN_COM19])

							elif bt == '0500' and str(DATE) == afterday2 and(str(TIME) == '0000' or str(TIME) == '0100' or str(TIME) == '0200' or str(TIME) == '0300' or str(TIME) == '0400' or str(TIME) == '0500'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY3_RAIN_COM00])
							elif bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY3_RAIN_COM06])
							elif bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200') :
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY3_RAIN_COM09])
							elif bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY3_RAIN_COM13])
							elif bt == '0500' and str(DATE) == afterday2 and (str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
								data5.append([STN, NAME, DATE, TIME[0:2], RAIN_AMT,DAY3_RAIN_COM19])
					...
					if CATEGORY == 'POP': # 강수확률정보 수집 : 1시간 간격
						...
						if int(hr) < 14 : # 당일 06시 자료가 있는 0500과 최신자료인 0800 base_time사용
							if bt == '0500' and str(DATE) == today and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800' or str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):        
								data6.append([STN, NAME, DATE, TIME[0:2], POP])
							#elif bt == '0800' and str(DATE) == today and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
							#	data6.append([STN, NAME, DATE, TIME[0:2], POP])
							elif bt == '0500' and (str(DATE) == afterday1 or str(DATE) == afterday2):
								data6.append([STN, NAME, DATE, TIME[0:2], POP])
					...
					if CATEGORY == 'REH': # 풍속정보 수집 : 3시간 간격
						...
						if int(hr) < 14 : # 당일 06시 자료가 있는 0500과 최신자료인 0800 base_time사용
							if bt == '0500' and str(DATE) == today and (str(TIME) == '0600' or str(TIME) == '0700' or str(TIME) == '0800' or str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
								data7.append([STN, NAME, DATE, TIME[0:2], REH])
							#elif bt == '0800' and str(DATE) == today and (str(TIME) == '0900' or str(TIME) == '1000' or str(TIME) == '1100' or str(TIME) == '1200' or str(TIME) == '1300' or str(TIME) == '1400' or str(TIME) == '1500' or str(TIME) == '1600' or str(TIME) == '1700' or str(TIME) == '1800' or str(TIME) == '1900' or str(TIME) == '2000' or str(TIME) == '2100' or str(TIME) == '2200' or str(TIME) == '2300'):
							#	data7.append([STN, NAME, DATE, TIME[0:2], REH])
							elif bt == '0500' and (str(DATE) == afterday1 or str(DATE) == afterday2):
								data7.append([STN, NAME, DATE, TIME[0:2], REH])
			...
			if MCHECK2 == '03' :
				...
				while ll <= 6 : 
					...
					if AF == 'A' : 
						...
						for HH in HR2 : 
							data1.append([STN, NAME, afday, HH, 0])         # 동네예보 기온 마지막 시간자료 채우기
							data2.append([STN, NAME, afday, HH, SKY2])        # 중기예보 날씨 (오전/오후 결과 3시간 단위로 채워 넣기)
							data3.append([STN, NAME, afday, HH, 0])         # 동네예보 풍속 마지막 시간자료 채우기
							data5.append([STN, NAME, afday, HH, 0.0, 0.0])         # 동네예보 강수량 0으로 채우기
							data6.append([STN, NAME, afday, HH, DAY_RPROB])   # 중기예보 강수확률(오전/오후 결과 3시간 단위로 채워 넣기)
							data7.append([STN, NAME, afday, HH, 0])         # 동네예보 상대습도 마지막 시간자료 채우기
					elif AF == 'P' :
		...
		# [지수 산출용 자료 *_CITY.csv]
		ii = 0 
		while ii <= len(data1)-24 :
			#오전 09~12 오후 12~18  의 최소/최대/평균 값 추출
			if data1[ii+9][2] == afterday3 or  data1[ii+9][2] == afterday4 or  data1[ii+9][2] == afterday5 or  data1[ii+9][2] == afterday6 :  
				AIRT_DY_MIN = 0 ; AIRT_DY_MAX = 0 ; AIRT_DY_AVE = 0
				WSD_DY_MIN = 0 ; WSD_DY_MAX = 0 ; WSD_DY_AVE = 0
				SKY_DY = max(data2[ii+9][4],data2[ii+10][4],data2[ii+11][4],data2[ii+12][4],data2[ii+13][4],data2[ii+14][4],data2[ii+15][4],data2[ii+16][4],data2[ii+17][4],data2[ii+18][4])
				RAIN_AMT_DY = 0
				com.append([data1[ii][0],data1[ii][1],data1[ii][2],'DY', AIRT_DY_MIN, AIRT_DY_AVE, AIRT_DY_MAX, WSD_DY_MIN, WSD_DY_AVE, WSD_DY_MAX, SKY_DY, RAIN_AMT_DY])
			else :
				AIRT_AM_MIN = min(data1[ii+9][4],data1[ii+10][4],data1[ii+11][4],data1[ii+12][4]) ; AIRT_PM_MIN = min(data1[ii+12][4],data1[ii+13][4],data1[ii+14][4],data1[ii+15][4],data1[ii+16][4],data1[ii+17][4],data1[ii+18][4])
				AIRT_AM_MAX = max(data1[ii+9][4],data1[ii+10][4],data1[ii+11][4],data1[ii+12][4]) ; AIRT_PM_MAX = max(data1[ii+12][4],data1[ii+13][4],data1[ii+14][4],data1[ii+15][4],data1[ii+16][4],data1[ii+17][4],data1[ii+18][4])
				AIRT_AM_AVE = (data1[ii+9][4]+data1[ii+10][4]+data1[ii+11][4]+data1[ii+12][4])/4 ;  AIRT_PM_AVE = (data1[ii+12][4]+data1[ii+13][4]+data1[ii+14][4]+data1[ii+15][4]+data1[ii+16][4]+data1[ii+17][4]+data1[ii+18][4])/7
				
				WSD_AM_MIN = min(data3[ii+9][4],data3[ii+10][4],data3[ii+11][4],data3[ii+12][4]) ; WSD_PM_MIN = min(data3[ii+12][4],data3[ii+13][4],data3[ii+14][4],data3[ii+15][4],data3[ii+16][4],data3[ii+17][4],data3[ii+18][4])
				WSD_AM_MAX = max(data3[ii+9][4],data3[ii+10][4],data3[ii+11][4],data3[ii+12][4]) ; WSD_PM_MAX = max(data3[ii+12][4],data3[ii+13][4],data3[ii+14][4],data3[ii+15][4],data3[ii+16][4],data3[ii+17][4],data3[ii+18][4])
				WSD_AM_AVE = (data3[ii+9][4]+data3[ii+10][4]+data3[ii+11][4]+data3[ii+12][4])/4 ;  WSD_PM_AVE = (data3[ii+12][4]+data3[ii+13][4]+data3[ii+14][4]+data3[ii+15][4]+data3[ii+16][4]+data3[ii+17][4]+data3[ii+18][4])/7
		
				#하늘상태 보수적으로 적용 [맑음:1, 구름조금:2, 구름많음:3, 흐림:4]
				SKY_AM = max(data2[ii+9][4],data2[ii+10][4],data2[ii+11][4],data2[ii+12][4]) ; SKY_PM = max(data2[ii+12][4],data2[ii+13][4],data2[ii+14][4],data2[ii+15][4],data2[ii+16][4],data2[ii+17][4],data2[ii+18][4])
		
				#강수량 오전 오후
				RAIN_AMT_AM = data5[ii+12][5] ; RAIN_AMT_PM = data5[ii+18][5]
			
				com.append([data1[ii][0],data1[ii][1],data1[ii][2],'AM', AIRT_AM_MIN, AIRT_AM_AVE, AIRT_AM_MAX, WSD_AM_MIN, WSD_AM_AVE, WSD_AM_MAX, SKY_AM, RAIN_AMT_AM])
				com.append([data1[ii][0],data1[ii][1],data1[ii][2],'PM', AIRT_PM_MIN, AIRT_PM_AVE, AIRT_PM_MAX, WSD_PM_MIN, WSD_PM_AVE, WSD_PM_MAX, SKY_PM, RAIN_AMT_PM])
		
			ii = ii + 24
		
		with open(dir1+'/'+LIST+'_CITY_CHECK.csv','w',encoding='utf8') as file:
			file.write('STN,NAME,DATE,AM/PM,TEMP_MIN,TEMP_AVE,TEMP_MAX,WIND_MIN,WIND_AVE,WIND_MAX,SKY,RAIN_AMT\n')
			for i in com:
				file.write('{0},{1},{2},{3},{4:3.1f},{5:3.1f},{6:3.1f},{7:3.1f},{8:3.1f},{9:3.1f},{10},{11}\n'.format(i[0],i[1],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11]))

		# [시계열용 자료 *_CITY_Time.csv] #3시간 단위 정렬
		ii = 0
		while ii <= len(data1)-1 :
			AIR_TEMP = data1[ii][4]   # 기온(℃)
			SKY_STATUS = data2[ii][4] # 하늘상태[맑음:1, 구름많음:3, 흐림:4]
			WIND_SPD = data3[ii][4]   # 풍속(m/s)
			#WAVE_HGT = data4[ii][4]   # 파고(m)
			RAIN_AMT = data5[ii][4]   # 강수량(mm)
			RAIN_ACC = data5[ii][5]   # 누적 강수량(mm) : 00시~05시, 06시~08시, 09시~12시, 13시~18시, 19시~23시 / 누력자료 사용 시 오전은 12시(09~12 최종 누적값), 오후는 18시(13~18최종 누적값) 자료 활용해야함
			RAIN_PROB = data6[ii][4]  # 강수확률(%)
			REL_HU = data7[ii][4]     # 상대습도(%)
			#               STN           지역           날짜          시간                       
			com2.append([data1[ii][0], data1[ii][1], data1[ii][2], data1[ii][3], AIR_TEMP, WIND_SPD, SKY_STATUS, RAIN_AMT, RAIN_ACC, RAIN_PROB, REL_HU])
			ii += 1
		with open(dir1+'/'+LIST+'_CITY_time_CHECK.csv','w',encoding='utf8') as file:
			file.write('STN,NAME,DATE,HR,TEMP,WIND_SPD,SKY,RAIN_AMT,RAIN_ACC,RAIN_PROB,REL_HU\n')
			for i in com2:
		...
		del data1[:] ; del data2[:] ;del data3[:] ;del data4[:] ;del data5[:]; del data6[:]; del data7[:]; del com[:] ;  del com2[:]
