...
#[Info Data Read]=========================================================================================
POINT_INF = open('./Info/TL_Point_Info_ONAIR.csv','r',encoding='utf8')
	...
	if YMD == today :
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME and USE_YN == 'Y' :
				...
				DAY1.append([STN, AREA, W_AREA, NAME, today, TL_TIME[0], TL_TIME[1], TL_TIME[2], TL_TIME[3], round(TEMP_S[0],1),  round(TEMP_S[2],1), round(TEMP_S[1],1), round(WIND_S[0],1), round(WIND_S[2],1), round(WIND_S[1],1)])
			ii = ii + 1
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME:
				...
				DAY2.append([STN, AREA, W_AREA, NAME, afterday1, TL_TIME[0], TL_TIME[1], TL_TIME[2], TL_TIME[3], round(TEMP_S[0],1),  round(TEMP_S[2],1), round(TEMP_S[1],1), round(WIND_S[0],1), round(WIND_S[2],1), round(WIND_S[1],1)])
			ii = ii + 1
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				...
				DAY3.append([STN, AREA, W_AREA, NAME, afterday2, TL_TIME[0], TL_TIME[1], TL_TIME[2], TL_TIME[3], round(TEMP_S[0],1),  round(TEMP_S[2],1), round(TEMP_S[1],1), round(WIND_S[0],1), round(WIND_S[2],1), round(WIND_S[1],1)])
			ii = ii + 1
	elif YMD == afterday3 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		TL_TIME = TL_time_cal().tl_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME  :
				...
				DAY4.append([STN, AREA, W_AREA, NAME, afterday3, TL_TIME[0], TL_TIME[1], TL_TIME[2], TL_TIME[3], round(TEMP_S[0],1),  round(TEMP_S[2],1), round(TEMP_S[1],1), round(WIND_S[0],1), round(WIND_S[2],1), round(WIND_S[1],1)])
			ii = ii + 1
	elif YMD == afterday4 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		TL_TIME = TL_time_cal().tl_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				...
				DAY5.append([STN, AREA, W_AREA, NAME, afterday4, TL_TIME[0], TL_TIME[1], TL_TIME[2], TL_TIME[3], round(TEMP_S[0],1),  round(TEMP_S[2],1), round(TEMP_S[1],1), round(WIND_S[0],1), round(WIND_S[2],1), round(WIND_S[1],1)])
			ii = ii + 1
	elif YMD == afterday5 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		TL_TIME = TL_time_cal().tl_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME:
				...
				DAY6.append([STN, AREA, W_AREA, NAME, afterday5, TL_TIME[0], TL_TIME[1], TL_TIME[2], TL_TIME[3], round(TEMP_S[0],1),  round(TEMP_S[2],1), round(TEMP_S[1],1), round(WIND_S[0],1), round(WIND_S[2],1), round(WIND_S[1],1)])
			ii = ii + 1
	elif YMD == afterday6 :
		#SD_time_cal().split_time(YMD, START_TIME, END_TIME)
		TL_TIME = TL_time_cal().tl_time(YMD, START_TIME, END_TIME)
		...
		while ii <= INF_LEN-1 :
			...
			if SPLIT_NAME == NAME :
				...
				DAY7.append([STN, AREA, W_AREA, NAME, afterday6, TL_TIME[0], TL_TIME[1], TL_TIME[2], TL_TIME[3], round(TEMP_S[0],1),  round(TEMP_S[2],1), round(TEMP_S[1],1), round(WIND_S[0],1), round(WIND_S[2],1), round(WIND_S[1],1)])
			ii = ii + 1
...
#[Output Data] ========================================================================================
OUT_FNAME1=dir1+'/TLEQ_INDEX_FCST_onair_'+today+'.csv'
with open(OUT_FNAME1,'w',encoding='utf8') as file:
	...
	while ii <= COM_LEN-1 :
		#[전체 데이터 Writing]
		file.write(f'{today},{COM[ii][0]},{COM[ii][1]},{COM[ii][3]},{COM[ii][4]},{COM[ii][5]},{COM[ii][6]},{COM[ii][7]:3.2f},{COM[ii][8]},{COM[ii][10]:3.1f},{COM[ii][11]:3.1f},{COM[ii][12]:3.1f},{COM[ii][13]},{COM[ii][14]:3.1f},{COM[ii][15]:3.1f},{COM[ii][16]:3.1f},{COM[ii][17]},{COM[ii][20]},{COM[ii][21]},{COM[ii][24]:4.2f},{COM[ii][26]}\n')
		ii = ii + 1

OUT_FNAME2=dir1+'/TLEQ_INDEX_SERVICE_onair_'+today+'.csv'
with open(OUT_FNAME2,'w',encoding='euc-kr') as file:
